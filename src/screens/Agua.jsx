...
export default function Agua({ onToast }) {
  ...
  return (
    <div className="screen">
      <div className="card">
        <p className="card-title">Registrar água</p>
        <form onSubmit={salvar}>
          <div className="field-row">
            ...
            <div className="field">
              <label>Quantidade restante (ml)</label>
      ...
      <div className="card">
        <p className="card-title">
          Hoje
          <span className="mono">{totalColocado}ml colocados</span>
        </p>
        {carregando ? (
          ...
          <div className="entry-list">
            {registros.map(r => (
              <div key={r.id} className="entry-row">
                ...
                <span className="mono">
                  {r.quantidade_colocada}ml
                  {r.quantidade_restante != null ? ` · sobrou ${r.quantidade_restante}ml` : ''}
                </span>
              </div>
            ))}
          </div>
